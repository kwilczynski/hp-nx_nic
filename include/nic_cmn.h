...
#define    TX_ISCSI_V4	   0x20
#define    TX_ISCSI_V6	   0x21
...
#define NX_MAX_SUPPORTED_RDS_SIZE	(8192)
#define NX_MAX_SUPPORTED_JUMBO_RDS_SIZE	(1024)
...
#define DCC_CTXID	(MAX_RX_CONTEXTS-2)
#endif /* P3 */
...
#define NX_DEFAULT_INTR_COALESCE_TX_TIME_US     64
...
typedef struct {
	...
	union {
		...
		nic_config_hw_lro_t             config_hw_lro;
		__uint64_t			words[7];
	} body;
} nic_request_t;
