...
#define UNM_MSGTYPE_ISCSI_RSVD		0x2b
#define UNM_MSGTYPE_ISCSI_RSVD_1       0x10
#define UNM_MSGTYPE_ISCSI_RSVD_2       0x24
#define UNM_MSGTYPE_ISCSI_RSVD_3       0x0f
#define UNM_MSGTYPE_ISCSI_RSVD_4       0x31
#define UNM_MSGTYPE_ISCSI_RSVD_5       0x25
 ...
 * ============================== Doorbells ==============================
 *
 * These messages only show up on the doorbell queues and nowhere else.
 */
#define	UNM_MSGTYPE_GOOD_DBELL		0x0	/* CRB programmed: don't move */
#define	UNM_MSGTYPE_FCOE_IOCBDONE	0x1
#define	UNM_MSGTYPE_FCOE_RSPDONE	0x2
#define	UNM_MSGTYPE_FCOE_IOCBFREE	0x3
#define	UNM_MSGTYPE_FCOE_MBCOMP		0x4
#define	UNM_MSGTYPE_FCOE_EVENT		0x5
#define	UNM_MSGTYPE_BAD_DBELL		0x6	/* CRB programmed: don't move */
#define	UNM_MSGTYPE_FCOE_INTMODE	0x7
#define	UNM_MSGTYPE_FCOE_FUNC		0x8

/* iscsi msg types for peg4 
 * these should be kept in sync with the fcoe msgtypes since the 
 * demux routine is common
 */
#define UNM_MSGTYPE_ISCSI_HIF_WORK		0x20	
#define UNM_MSGTYPE_ISCSI_HIF_DMA_COMP		0x21	
#define UNM_MSGTYPE_ISCSI_REQ_DMA_COMPL		0x22
#define UNM_MSGTYPE_ISCSI_RESP_DMA_COMPL	0x23
